function createGrids(data) {
    ...
    $().w2grid({
        ...
        columns: [
            ...
            { field: 'nombre', caption: 'Apellido y nombres', size: '30%',
              sortable: true,
              resizable: true, sortable: true, editable: {type: 'text'} },
            { field: 'dni', caption: 'D.N.I.', size: '10%', resizable: true,
              editable: {type: 'number'} },
            { field: 'direccion', caption: 'Dirección', size: '15%',
              resizable: true, editable: {type: 'text'}},
            { field: 'localidad', caption: 'Localidad', size: '15%',
              resizable: true, editable: {type: 'text'}},
            { field: 'cuit', caption: 'CUIT/L', size: '10%', resizable: true,
              editable: {type: 'text'} },
            { field: 'licencia', caption: 'Licencia', size: '10%',
              resizable: true, editable: {type: 'text'} },
    ...
    $().w2grid({
        ...
        columns: [
            ...
            { field: 'tipovuelo', caption: 'Tipo vuelo', size: '10%', sortable: true,
              resizable: true,
              editable: {type: 'list', items: selectList['tiposVuelo']}},
            { field: 'desde', caption: 'Desde', size: '10%', resizable: true,
              editable: {type: 'text'} },
    ...
    $().w2grid({
        ...
        header: 'Combustible',
        show: {
            header: true, toolbar: true, footer: true, toolbarAdd: true,
            toolbarDelete: true, toolbarSave: true
        },
        searches: [
            { field: 'destino', caption: 'Destino', type: 'text' },
            { field: 'fecha', caption: 'Fecha', type: 'text' },
            { field: 'piloto', caption: 'Piloto', type: 'text' }
        ],
        sortData: [{ field: 'desde', direction: 'ASC'}],
        onAdd: addDefaultRecord,
        // onSave: updateData,
        // onDelete: deleteRecords,
        onChange: calcLitrosCisterna,
        columns: [
            { field: 'piloto', caption: 'Piloto', size: '30%', sortable: true,
              resizable: true, editable: {type: 'combo', items: selectList['socios']} },
            { field: 'fecha', caption: 'Fecha', size: '30%', resizable: true,
              editable: {type: 'date'} },
            ...
            { field: 'destino', caption: 'Destino', size: '20%', resizable: true,
              editable: {type: 'list', items: selectList['depComb']} },
            { field: 'contadorinicial', caption: 'Contador Inicial', size: '25%',
              resizable: true, editable: {type: 'number'} },
            { field: 'contadorfinal', caption: 'Contador Final', size: '25%',
              resizable: true, editable: {type: 'number'} },
